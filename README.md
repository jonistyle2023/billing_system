...
*   **Módulo de Facturación**: Interfaz dedicada para agregar productos al carrito, calcular subtotales, IVA y el total final de manera automática.
...
1.  **Vistas (`src/main/resources/upse/calculacion/vistas`)**: Archivos FXML (`Principal.fxml`, `Factura.fxml`, etc.) que definen las ventanas, botones, tablas y formularios.
...
3.  **Modelo (`src/main/java/upse/calculacion/modelo`)**: Clases de dominio (ej. `Cliente.java`) encargadas de estructurar y retener los datos dentro del sistema.
